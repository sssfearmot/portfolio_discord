...
export default function Footer() {
  return (
    <div className='bg-discord-notQuiteDark flex flex-col py-16 sm:px-20 px-6'>
      ...
      <div className='flex flex-row justify-between justify-items-center items-center pt-8 mt-8 border-t-2 border-discord-experiment500'>
        ...
        <a
          href='#'
          className='px-4 py-2 ease-linear transition duration-150 hover:shadow-lg hover:bg-discord-indigo rounded-full bg-discord-experiment500 text-white text-sm'
        >
          Sign up
        </a>
      </div>
